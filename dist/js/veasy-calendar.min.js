...
"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function _iterableToArray(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}angular.module("veasy.calendar").directive("vCalendar",["$timeout","$filter","catalogService","calendarService",function(e,u,f,d){return{restrict:"E",replace:!0,templateUrl:"veasy-calendar.html",scope:{config:"<"},link:function(m,e,t,n){var o,a=function(){return[{time:"00:00",show:!1},{time:"01:00",show:!0},{time:"02:00",show:!0},{time:"03:00",show:!0},{time:"04:00",show:!0},{time:"05:00",show:!0},{time:"06:00",show:!0},{time:"07:00",show:!0},{time:"08:00",show:!0},{time:"09:00",show:!0},{time:"10:00",show:!0},{time:"11:00",show:!0},{time:"12:00",show:!0},{time:"13:00",show:!0},{time:"14:00",show:!0},{time:"15:00",show:!0},{time:"16:00",show:!0},{time:"17:00",show:!0},{time:"18:00",show:!0},{time:"19:00",show:!0},{time:"20:00",show:!0},{time:"21:00",show:!0},{time:"22:00",show:!0},{time:"23:00",show:!0}]},i=function(){m.$watchCollection("config.events",function(e,t){e.length&&(m.config.events=u("orderBy")(e,"startDate",!1),o=f.catalogEvents(m.config,e),r(m.config,o))})},r=function(e,t){m.calendar=d.buildCalendar(e,t),"week"===m.viewMode&&(m.weeklyEventsLines=c(m.calendar,t))};m.onClickDay=function(e,t){var n=t?t.time.split(":")[0]:0,o=t?t.time.split(":")[1]:0,a=e.date.clone().hour(n).minute(o);m.$emit("veasycalendar:onClickDay",a)},m.onClickEvent=function(e,t){e.stopPropagation();var n=angular.copy(t);n.$$hashKey&&delete n.$$hashKey,n.veasyId&&delete n.veasyId,n.colors&&delete n.colors,m.$emit("veasycalendar:onClickEvent",n)},m.onClickToday=function(){m.config.initialDate=moment(),r(m.config,o)},m.onChangeViewMode=function(e){m.config.viewMode=e,m.viewMode=e,m.config.initialDate=moment(),o=f.catalogEvents(m.config,m.config.events),r(m.config,o),m.$emit("veasycalendar:onChangeViewMode")},m.onPreviousMonth=function(){m.$emit("veasycalendar:onClickPreviousMonthStart"),m.config.initialDate=m.calendar.initialDate.subtract(1,"month"),r(m.config,o),m.$emit("veasycalendar:onClickPreviousMonthEnd")},m.onNextMonth=function(){m.$emit("veasycalendar:onClickNextMonthStart"),m.config.initialDate=m.calendar.initialDate.add(1,"month"),r(m.config,o),m.$emit("veasycalendar:onClickNextMonthEnd")},m.onPreviousWeek=function(){m.$emit("veasycalendar:onClickPreviousWeekStart"),m.config.initialDate=m.calendar.initialDate.subtract(1,"week"),r(m.config,o),m.$emit("veasycalendar:onClickPreviousWeekEnd")},m.onNextWeek=function(){m.$emit("veasycalendar:onClickNextWeekStart"),m.config.initialDate=m.calendar.initialDate.add(1,"week"),r(m.config,o),m.$emit("veasycalendar:onClickNextWeekEnd")};var l=function(){for(var e=[],t=0;t<7;t++)e.push({isEmpty:!0});return e},s=function(e,t){return e.reduce(function(e,t){return e.concat(t)},[]).some(function(e){return e.veasyId===t})},c=function(e){for(var t=function(e){for(var t=Math.max.apply(Math,_toConsumableArray(e.week.map(function(e){return e.multiDayEvents.length}))),n=[],o=0;o<t;o++)n.push(l());return n}(e),n=0;n<e.week.length;n++)for(var o=e.week[n],a=0;a<o.multiDayEvents.length;a++)for(var i=o.multiDayEvents[a],r=0;r<t.length;r++)if(t[r][n].isEmpty){if(s(t,i.veasyId))break;t[r][n]=i;for(var c=1;c<i.payload-i.chunk;c++)t[r][n+c]&&(t[r][n+c].isEmpty=!1);break}return t};m.getMonthlyEventStyle=function(e){return{color:e.colors.text,"background-color":e.colors.background,"border-color":e.colors.background}},m.getWeeklyEventStyle=function(e){var t=e.chunk,n=e.payload,o=n,a=moment(e.startDate).day();return 0<t&&(a=moment(e.startDate).add(t,"days").day()),0<t&&(e.isLeftArrow=!0,o=n-t),7<a+n-t&&(e.isRightArrow=!0,o=7-a),7<n+a&&1,{position:"absolute",left:"".concat(2,"px"),width:"calc(100% * ".concat(o," + ").concat(o-1,"px - ").concat(4,"px)"),color:e.colors.text,"background-color":e.colors.background,"border-color":e.colors.background,"z-index":2}},m.getEventStyle=function(e,t,n,o){var a=o.length||1,i="".concat(100/a,"%"),r=moment.duration(moment(e.endDate).diff(moment(e.startDate))),c=5*(Math.ceil(r.asMinutes()/60)-1),l=moment(e.endDate).diff(moment(e.startDate),"minutes"),s="".concat(t," * ").concat(i);return{position:"absolute",left:"calc(".concat(s,")"),top:!!m.config.organizeEventBasedOnTime&&"".concat(100*e.startDate.minutes()/60,"%"),width:"calc(100% - (".concat(s,"))"),height:"calc(".concat(l/60*100,"% + ").concat(c,"px)"),"min-height":"17px",color:e.colors.text,"background-color":e.colors.background}},m.getEventTitle=function(){return(m.config.fields.find(function(e){return e.isEventTitle})||{}).property||"..."},m.getEventTime=function(e,t){return"".concat(moment(e).format("HH:mm")," - ").concat(moment(t).format("HH:mm"))},m.viewModes=["month","week"],m.viewMode=m.config.viewMode||m.viewModes[0],m.config.initialDate=m.config.initialDate?moment(m.config.initialDate).startOf("day"):moment().startOf("day"),m.config.timeslots=a(),m.config.utcOffset=(m.config.utcOffset||"").replace(":",""),i()}}}]);