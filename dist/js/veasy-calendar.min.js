...
"use strict";angular.module("veasy.calendar").directive("vCalendar",["$timeout","vCalendarService",function(n,r){return{restrict:"E",replace:!0,templateUrl:"veasy-calendar.html",scope:{config:"="},link:function(t,n,e,a){var i,o=function(n){i=r.catalogEvents(n),t.calendar=r.buildCalendar(n,i)},c=function(){t.$watchCollection("config.events",function(n,e){t.config.events=n,o(t.config)})};t.getEventTitle=function(){return(t.config.fields.find(function(n){return n.isEventTitle})||{}).property||"..."},t.getEventTime=function(n,e){var t="HH:mm";return"".concat(moment(n).format(t)," - ").concat(moment(e).format(t))},t.previousMonth=function(){t.$emit("veasyCalendar:onClickPreviousMonthStart"),t.config.initialDate=t.calendar.date.subtract(1,"month"),t.calendar=r.buildCalendar(t.config,i),t.$emit("veasyCalendar:onClickPreviousMonthEnd")},t.nextMonth=function(){t.$emit("veasyCalendar:onClickNextMonthStart"),t.config.initialDate=t.calendar.date.add(1,"month"),t.calendar=r.buildCalendar(t.config,i),t.$emit("veasyCalendar:onClickNextMonthEnd")},t.onClickDay=function(n,e){t.$emit("veasyCalendar:onClickDay",e)},t.onClickEvent=function(n,e){n.stopPropagation(),t.$emit("veasyCalendar:onClickEvent",e)},t.openedEvent={},o(t.config),c()}}}]);