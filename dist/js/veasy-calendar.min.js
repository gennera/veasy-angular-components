...
"use strict";function _toConsumableArray(t){return _arrayWithoutHoles(t)||_iterableToArray(t)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function _iterableToArray(t){if(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t))return Array.from(t)}function _arrayWithoutHoles(t){if(Array.isArray(t)){for(var e=0,n=new Array(t.length);e<t.length;e++)n[e]=t[e];return n}}angular.module("veasy.calendar").directive("vCalendar",["$timeout","$filter","catalogService","calendarService",function(t,u,f,d){return{restrict:"E",replace:!0,templateUrl:"veasy-calendar.html",scope:{config:"<"},link:function(a,t,e,n){var o,i=function(){return[{time:"00:00",show:!1},{time:"01:00",show:!0},{time:"02:00",show:!0},{time:"03:00",show:!0},{time:"04:00",show:!0},{time:"05:00",show:!0},{time:"06:00",show:!0},{time:"07:00",show:!0},{time:"08:00",show:!0},{time:"09:00",show:!0},{time:"10:00",show:!0},{time:"11:00",show:!0},{time:"12:00",show:!0},{time:"13:00",show:!0},{time:"14:00",show:!0},{time:"15:00",show:!0},{time:"16:00",show:!0},{time:"17:00",show:!0},{time:"18:00",show:!0},{time:"19:00",show:!0},{time:"20:00",show:!0},{time:"21:00",show:!0},{time:"22:00",show:!0},{time:"23:00",show:!0}]},r=function(){a.$watchCollection("config.events",function(t,e){t.length&&(a.config.events=u("orderBy")(t,"startDate",!1),o=f.catalogEvents(a.config,t),c(a.config,o))})},c=function(t,e){a.calendar=d.buildCalendar(t,e),"week"===a.viewMode&&(a.weeklyEventsLines=m(a.calendar,e))};a.onClickDay=function(t,e){var n=e?e.time.split(":")[0]:0,o=e?e.time.split(":")[1]:0,i=t.date.clone().hour(n).minute(o);a.$emit("veasycalendar:onClickDay",i)},a.onClickEvent=function(t,e){t.stopPropagation(),a.$emit("veasycalendar:onClickEvent",e)},a.onClickToday=function(){a.config.initialDate=moment(),c(a.config,o)},a.onChangeViewMode=function(t){a.config.viewMode=t,a.viewMode=t,a.config.initialDate=moment(),o=f.catalogEvents(a.config,a.config.events),c(a.config,o),a.$emit("veasycalendar:onChangeViewMode")},a.onPreviousMonth=function(){a.$emit("veasycalendar:onClickPreviousMonthStart"),a.config.initialDate=a.calendar.initialDate.subtract(1,"month"),c(a.config,o),a.$emit("veasycalendar:onClickPreviousMonthEnd")},a.onNextMonth=function(){a.$emit("veasycalendar:onClickNextMonthStart"),a.config.initialDate=a.calendar.initialDate.add(1,"month"),c(a.config,o),a.$emit("veasycalendar:onClickNextMonthEnd")},a.onPreviousWeek=function(){a.$emit("veasycalendar:onClickPreviousWeekStart"),a.config.initialDate=a.calendar.initialDate.subtract(1,"week"),c(a.config,o),a.$emit("veasycalendar:onClickPreviousWeekEnd")},a.onNextWeek=function(){a.$emit("veasycalendar:onClickNextWeekStart"),a.config.initialDate=a.calendar.initialDate.add(1,"week"),c(a.config,o),a.$emit("veasycalendar:onClickNextWeekEnd")};var l=function(){for(var t=[],e=0;e<7;e++)t.push({isEmpty:!0});return t},s=function(t,e){return t.reduce(function(t,e){return t.concat(e)},[]).some(function(t){return t.veasyId===e})},m=function(t){for(var e=function(t){for(var e=Math.max.apply(Math,_toConsumableArray(t.week.map(function(t){return t.multiDayEvents.length}))),n=[],o=0;o<e;o++)n.push(l());return n}(t),n=0;n<t.week.length;n++)for(var o=t.week[n],i=0;i<o.multiDayEvents.length;i++)for(var a=o.multiDayEvents[i],r=0;r<e.length;r++)if(e[r][n].isEmpty){if(s(e,a.veasyId))break;e[r][n]=a;for(var c=1;c<a.payload-a.chunk;c++)e[r][n+c]&&(e[r][n+c].isEmpty=!1);break}return e};a.getMonthlyEventStyle=function(t){return{color:t.colors.text,"background-color":t.colors.background,"border-color":t.colors.background}},a.getWeeklyEventStyle=function(t){var e=t.chunk,n=t.payload,o=n,i=moment(t.startDate).day();return 0<e&&(i=moment(t.startDate).add(e,"days").day()),0<e&&(t.isLeftArrow=!0,o=n-e),7<i+n-e&&(t.isRightArrow=!0,o=7-i),7<n+i&&1,{position:"absolute",left:"".concat(2,"px"),width:"calc(100% * ".concat(o," + ").concat(o-1,"px - ").concat(4,"px)"),color:t.colors.text,"background-color":t.colors.background,"border-color":t.colors.background,"z-index":2}},a.getEventStyle=function(t,e,n,o){var i=o.length-1||1,a="".concat(100/i,"%"),r=moment.duration(moment(t.endDate).diff(moment(t.startDate))),c=5*(Math.ceil(r.asMinutes()/60)-1),l=moment(t.endDate).diff(moment(t.startDate),"minutes");return{position:"absolute",left:"calc(".concat(e," * ").concat(a," - ").concat(60/i*e,"px)"),top:"".concat(100*t.startDate.minutes()/60,"%"),width:"calc(100% - ".concat(4,"px - (").concat(i," * ").concat(a,"))"),height:"calc(".concat(l/60*100,"% + ").concat(c,"px)"),"min-width":"60px","min-height":"17px",color:t.colors.text,"background-color":t.colors.background}},a.getEventTitle=function(){return(a.config.fields.find(function(t){return t.isEventTitle})||{}).property||"..."},a.getEventTime=function(t,e){return"".concat(moment(t).format("HH:mm")," - ").concat(moment(e).format("HH:mm"))},a.viewModes=["month","week"],a.viewMode=a.config.viewMode||a.viewModes[0],a.config.initialDate=a.config.initialDate?moment(a.config.initialDate).startOf("day"):moment().startOf("day"),a.config.timeslots=i(),r()}}}]);